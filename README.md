...
* `examples`: sample agent container(s) to be executed on the platform; to be defined, preferrably one using teh JIAC VI reference implementaiton and another, simpler one using plain Python (e.g. FastAPI, possibly just a subset of the API)
