...
* go to `POST containers`, click "try it out", and replace the value of `image` by the entire content from `examples/sample-container/src/main/resources/container.json` 
