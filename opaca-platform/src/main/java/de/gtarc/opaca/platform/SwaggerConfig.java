...
@OpenAPIDefinition(info=@Info(
        ...
        description = """
                ...
                * **info**: get basic information on this Runtime Platform and its properties
                ...
                Complementary to the API docs generated by Swagger, an open-API compliant documentation for the currently available action can be found at [/v3/api-docs/actions](/v3/api-docs/actions) (or [/v3/api-docs/actions?format=YAML](/v3/api-docs/actions?format=YAML) for YAML).
                """
))
@SecuritySchemes({
        @SecurityScheme(
