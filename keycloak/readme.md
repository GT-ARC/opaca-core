...
Afterward, run `python keycloak-setup.py` to set up an `opaca` realm, an `opaca-rp` client, as well as the expected roles. Use the `--user` parameter to also create some dummy users necessary for the unit tests.
