...
/**
 * Full API that has to be provided by OPACA Agent Containers. This includes all the common Agents API,
...
public interface AgentContainerApi extends AgentsApi {
     ...
     * a token and associates that with the login credentials (or a cached client object or similar). In later
