...
If authentication is enabled, the process will require both platforms to be connected to the same Keycloak instance and Realm so they can authenticate at each others.
